...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public static class FeedEntry implements BaseColumns {
        ...
        public static final String COLUMN_NAME_EVALUATE = "evaluate"; //컬럼 명
        public static final String COLUMN_NAME_TIME = "time"; //컬럼 명
        public static final String COLUMN_NAME_QUANTITY = "quantity"; //컬럼 명
        public static final String COLUMN_NAME_DATE = "date"; //컬럼 명
        public static final String COLUMN_NAME_AREA = "area"; //컬럼 명
